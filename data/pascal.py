...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot):
        ...
        self.img_path = os.path.join(r'C:\Users\97650\Desktop\few-shot\PATNet-master\VOC2012\JPEGImages\\')
        self.ann_path = os.path.join(r'C:\Users\97650\Desktop\few-shot\PATNet-master\VOC2012\SegmentationClassAug\\')
        print("************")
        print(self.img_path)
