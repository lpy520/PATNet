...
class Correlation:
    ...
    def multilayer_correlation(cls, query_feats, support_feats, stack_ids):
        ...
        for idx, (query_feat, support_feat) in enumerate(zip(query_feats, support_feats)):
            ...
            support_feat = support_feat / (support_feat.norm(dim=1, p=2, keepdim=True) + eps)    #L2范数进行归一化
            ...
            #corr张量将包含query_feat和support_feat之间的相关性，这是一个五维张量，其中每个元素表示一个查询特征与支持特征之间的相关性
